...
Original file is located at
    https://colab.research.google.com/drive/1PHX98qRMbjUxe9c_QK3eTz-NtoReNs_f
"""
...
def train_model():
  if not os.path.exists('customer_churn_mock.csv'):
    ...
    EXPECTED_FEATURES = ['Age', 'Tenure_Months', 'Monthly_Charge', 'Support_Tickers']
...
charge = st.sidebar.number_input("ค่าใช้จ่ายต่อเดือน (บาท)", 500.00, 3000.00, 1500.00)
...
if prediction == 1:
  ...
  * **Expected ROI:** ค่าใช้จ่ายในการโทร+ส่วนลด คุ้มค่ากว่าการหาลูกค้าใหม่
  ...
  st.error(f"✅ มีความเสี่ยงน้อยโดยท่ี่ลูกค้ารายนี้มีแนวโน้มใช้งานต่อ (โดยมีความเสี่ยงเพียง {probability: .1%})")
